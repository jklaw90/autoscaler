...
var _ = ActuationSuiteE2eDescribe("Actuation", func() {
	...
	ginkgo.It("evicts and updates pods with native sidecars", func() {
	...
	ginkgo.It("does not evict pods when native sidecar recommendations are within bounds", func() {
	...
	ginkgo.It("respects native sidecar scaling mode Off and does not evict", func() {
		ginkgo.By("Setting up a deployment with native sidecar")
		d := NewHamsterDeploymentWithNativeSidecar(f,
			ParseQuantityOrDie("100m"),  /*main CPU*/
			ParseQuantityOrDie("100Mi"), /*main memory*/
	...
	ginkgo.It("handles in-place updates for native sidecars", func() {
		ginkgo.By("Setting up a deployment with native sidecar")
		d := NewHamsterDeploymentWithNativeSidecar(f,
			ParseQuantityOrDie("100m"),  /*main CPU*/
			ParseQuantityOrDie("100Mi"), /*main memory*/
